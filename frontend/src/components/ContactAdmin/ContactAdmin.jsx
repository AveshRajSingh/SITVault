...
import { FiArrowRight, FiSend, FiUser, FiMail, FiMessageSquare, FiChevronDown, FiChevronUp } from 'react-icons/fi';
...
function ContactAdmin() {
  ...
  // Reset admin selection when admins change
  useEffect(() => {
        ...
        <div className="mx-auto max-w-2xl">
          <div className="text-center my-4 md:my-8">
            <p className="text-lg text-gray-600">
              Have a question or need assistance? Send a message to one of our administrators.
            </p>
          </div>
              ...
              <div>
                ...
                {adminsLoading ? (
                  ...
                  <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-200">
                    <p className="text-gray-500 mb-2">No administrators available at the moment.</p>
                    <p className="text-sm text-gray-400">Please try again later or contact support directly.</p>
                  </div>
                ) : (
                  <div>
