    ...
    <div className="px-4 py-3 border-b border-gray-100">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent"
        />
